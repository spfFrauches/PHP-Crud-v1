...
window.addEventListener("load", function (event) { 
    ...
    $("#caixaRamal").focusout(function () {  
        ...
        $.ajax({ 
            ...
            if ( checagemCaixaRamal == 'caixaerro' ) {
                alertaErroCaixa();       
                Swal.fire({
                    icon: 'warning',
...
$("#formAlertaSuporte").submit(function () {
    ...
    $.ajax({
        ...
        if (obj.dados == 99) {                             
            ...
            Swal.fire({
                icon: 'warning',
                title: 'Por favor verifique a Data Final, não pode ser menor que a data e hora atual...',
            });
        } else if (obj.dados == 977) { 
            alertaErroDataFinal();     
            Swal.fire({
                icon: 'warning',
                title: 'Por favor verifique a Data Final, não pode ser menor que a data e hora inicial...',
            });
